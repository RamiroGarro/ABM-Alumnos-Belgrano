...
function mostrar() {
  ...
  document.getElementById('linea_6_1').innerHTML = urlParams['provincia'];
  document.getElementById('linea_7_1').innerHTML = urlParams['coment'];
...
{
var fieldRequired = new Array ("nombre","apellidos", "car", "nrodoc", "nroinsc","nrotelefono","provincia","coment","nombremat");

var fieldDescription = new Array("Nombre","Apellidos", "Carrera", "Nro. documento", "Nro. inscripción","Nro. de teléfono", "Provincia", "Comentarios","Nombre de la materia");
			...
			switch(obj.type)
			 ...
			 case "text":
			   ...
			   if(obj.name == "nrodoc" && !Esentero(obj.value)){
                           ...
                           else if(obj.name == "nrotelefono" && !Esentero(obj.value)){
                             	        alertMsg += " - " + fieldDescription[i] + "\n";
                           }
			   break;
			 case "textarea":
